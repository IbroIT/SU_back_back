...
class HSMInfo(models.Model):
    ...
    history_kg = models.TextField(verbose_name="История школы (KG)", blank=True)
    history_en = models.TextField(verbose_name="История школы (EN)", blank=True)
    
    main_directions = models.TextField(verbose_name="Основные направления")
    main_directions_kg = models.TextField(verbose_name="Основные направления (KG)", blank=True)
    main_directions_en = models.TextField(verbose_name="Основные направления (EN)", blank=True)
...
class Program(models.Model):
    ...
    name_kg = models.CharField(max_length=200, verbose_name="Название программы (KG)", blank=True)
    name_en = models.CharField(max_length=200, verbose_name="Название программы (EN)", blank=True)
    
    program_type = models.CharField(max_length=20, choices=PROGRAM_TYPES, verbose_name="Тип программы")
    study_form = models.CharField(max_length=20, choices=STUDY_FORMS, verbose_name="Форма обучения")
    ...
    description_kg = models.TextField(verbose_name="Описание программы (KG)", blank=True)
    description_en = models.TextField(verbose_name="Описание программы (EN)", blank=True)
    
    competencies = models.TextField(verbose_name="Получаемые компетенции")
    competencies_kg = models.TextField(verbose_name="Получаемые компетенции (KG)", blank=True)
    competencies_en = models.TextField(verbose_name="Получаемые компетенции (EN)", blank=True)
    
    career_prospects = models.TextField(verbose_name="Карьерные перспективы")
    career_prospects_kg = models.TextField(verbose_name="Карьерные перспективы (KG)", blank=True)
    career_prospects_en = models.TextField(verbose_name="Карьерные перспективы (EN)", blank=True)
...
class LearningGoal(models.Model):
    ...
    competencies_kg = models.TextField(verbose_name="Компетенции (KG)", blank=True)
    competencies_en = models.TextField(verbose_name="Компетенции (EN)", blank=True)
    
    career_prospects = models.TextField(verbose_name="Карьерные перспективы")
    career_prospects_kg = models.TextField(verbose_name="Карьерные перспективы (KG)", blank=True)
    career_prospects_en = models.TextField(verbose_name="Карьерные перспективы (EN)", blank=True)
    
    programs = models.ManyToManyField(Program, verbose_name="Связанные программы", blank=True)
