...
def create_hsm_info():
    ...
    hsm_info, created = HSMInfo.objects.get_or_create(
        ...
        defaults={
            'title_kg': "Жогорку менеджмент мектеби",
            'title_en': "Graduate School of Management",
            'description': """Высшая школа менеджмента Салымбекова Университета - ведущий центр подготовки высококвалифицированных управленческих кадров в Кыргызстане. Мы готовим профессиональных менеджеров, способных эффективно работать в условиях современной экономики.""",
            'description_kg': """Салымбеков Университетинин Жогорку менеджмент мектеби - Кыргызстандагы жогорку квалификациялуу башкаруу кадрларын даярдоочу алдыңкы борбор. Биз заманбап экономика шартында натыйжалуу иштей турган кесипкөй менеджерлерди даярдайбыз.""",
